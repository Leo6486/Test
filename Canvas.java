...
public class Canvas
{
	...
	public static void initialize() {
    	// Obtenir l'instance unique de Canvas
    	Canvas canvas = Canvas.getCanvas();
   	 
    	// Définir le délai pour s'assurer que le Canvas est visible avant de dessiner
    	canvas.wait(1000);
    	...
    	// Calculer la position pour centrer la terre
    	int earthX = (canvasWidth - earthWidth) / 2;
    	int earthY = (canvasHeight - earthHeight) / 2;
   	 
    	// Créer un rectangle pour la terre
    	Rectangle earth = new Rectangle(earthX, earthY, earthWidth, earthHeight);
   	 
    	// Dessiner la terre avec la couleur verte
    	canvas.draw(new Object(), Colour.GREEN, earth);
	}
}
